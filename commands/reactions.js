...
export async function autorxn(message, client) {
    ...
    try {
        ...
        if (input === 'on') {
            ...
            await bug(
                ...
                `Autorxn has been turned *${input.toUpperCase()}*.`,
                3
            );
        
        } else if (input === "off"){

             userConfig.autorxn = false;
        ...
        await client.sendMessage(message.key.remoteJid, {
            ...
            text: `❌ Error while updating autorxn settings: ${error.message}`,
        });
    }
}

export default { auto, autorxn };